var userMessageLibrary = angular.module('wellApp.libraries.notification', ['ngSanitize']);

userMessageLibrary.service( 'wellApp.libraries.notification.screenNotifyService', ['$timeout',
function($timeout) {
...
userMessageLibrary.service( 'wellApp.libraries.notification.screenNotifyService2', ['$timeout',
function($timeout) {
